...
export const enUS: Translations = {
  ...
  capabilities: {
    ...
    description: "Add tools and skills that help DeepHourAI work your way.",
    plugins: "Plugins",
    skills: "Skills",
  ...
  welcome: {
    ...
    description:
      "Welcome to DeepHourAI, your AI agent platform. With built-in and custom skills, DeepHourAI helps you search on the web, analyze data, and generate artifacts like slides, web pages and do almost anything.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own skill to release the power of DeepHourAI. With customized skills,\nDeepHourAI can help you search on the web, analyze data, and generate\n artifacts like slides, web pages and do almost anything.",
  },
  ...
  inputBox: {
    ...
    disclaimer: "DeepHourAI is AI and can make mistakes",
    createSkillPrompt:
    ...
    voiceInputStart:
      "Dictate with voice. DeepHourAI receives only transcribed text; audio is handled by your browser or system speech service.",
  ...
  backgroundTasks: {
    ...
    cancellationRetrying: (attempt) =>
      `Cancellation attempt ${attempt} failed; DeepHourAI will keep retrying.`,
    notificationRetrying: (attempt) =>
      `Chat notification attempt ${attempt} failed; DeepHourAI will retry with backoff.`,
    notificationStopped:
      "Chat notification delivery stopped after repeated or permanent failures.",
    trackingDegraded: "Status checks are delayed; DeepHourAI is still retrying.",
  ...
  scheduledTasks: {
    ...
    context: {
      ...
      reuseNoticeDescription:
        "If this thread has an active run at the scheduled time, DeepHourAI queues this occurrence and starts it when the thread is available. It fails if the configured queue wait limit is exceeded.",
    },
    search: {
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. DeepHourAI is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but DeepHourAI could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  // Workspace
  workspace: {
    officialWebsite: "DeepHourAI's official website",
    githubTooltip: "DeepHourAI on GitHub",
    settingsAndMore: "Settings and more",
    visitGithub: "DeepHourAI on GitHub",
    reportIssue: "Report an issue",
    contactUs: "Contact us",
    about: "About DeepHourAI",
    logout: "Log out",
  ...
  channels: {
    ...
    descriptions: {
      buzz: "Buzz channels and direct messages through your DeepHourAI agent.",
      telegram: "Telegram direct messages through your DeepHourAI bot.",
      slack: "Slack workspace messages and mentions.",
      discord: "Discord server messages through your DeepHourAI bot.",
      feishu: "Feishu and Lark messages through your DeepHourAI app.",
      dingtalk: "DingTalk Stream Push messages through your DeepHourAI bot.",
      wechat: "WeChat iLink messages through your DeepHourAI bot.",
      wecom: "WeCom messages through your DeepHourAI AI bot.",
    },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to DeepHourAI",
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate DeepHourAI faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how DeepHourAI looks and behaves for you.",
    sections: {
      account: "Account",
    ...
    memory: {
      title: "Memory",
      description:
        "DeepHourAI automatically learns from your conversations in the background. These memories help DeepHourAI understand you better and deliver a more personalized experience.",
  ...
  "mcpServers": {
    ...
    channels: {
      title: "Channels",
      description:
        "Connect IM accounts that can send messages to DeepHourAI from outside the browser.",
      disabled:
    ...
    integrations: {
      ...
      lark: {
        ...
        changeAppDescription:
          "Point your DeepHourAI account at a different Lark/Feishu app. This only affects your account; other users are not changed.",
        ...
        authStarted:
          "Authorization page opened. DeepHourAI will detect completion automatically.",
        authorizationStillPending:
          'Authorization is not complete yet. Finish it in the browser; DeepHourAI keeps checking automatically. You can click "I completed authorization" if the page does not update.',
        permissionTitle: "Authorization scope",
        permissionDescription:
          "By default, DeepHourAI only completes the base sign-in and does not request any business permissions. Select the domains you need here; connected users can re-authorize to add more (scopes accumulate).",
        authDomains: {
          calendar: {
            label: "Calendar",
            description:
        ...
        openAuthLinkDescription:
          "Open the link below to authorize. DeepHourAI keeps checking automatically and will save the connection after approval.",
        waitingAuthTitle: "Waiting for Lark authorization",
        waitingAuthDescription:
          "Finish authorization in the browser page that just opened. DeepHourAI will update this panel automatically; the button below is only a fallback.",
        ...
        authNextDescription:
          "Click “Connect Lark”; DeepHourAI checks the current status first and opens browser authorization only when disconnected or expired.",
      },
    },
    skills: {
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of DeepHourAI.",
    ...
    notification: {
      title: "Notification",
      description:
        "DeepHourAI only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
      requestPermission: "Request notification permission",
      deniedHint:
        "Notification permission was denied. You can enable it in your browser's site settings to receive completion alerts.",
      testButton: "Send test notification",
      testTitle: "DeepHourAI",
    ...
    account: {
      ...
      ssoPasswordMessage:
        "This account signs in with {provider}, so DeepHourAI cannot manage or change its password here. Use your SSO provider's account settings instead.",
  ...
  login: {
    ...
    rememberMeDescription:
      "Keep this browser session when possible. DeepHourAI stores only your email, never your password.",
    ...
    adminSetupRequiredDescription:
      "DeepHourAI needs an administrator account before new regular accounts can be created.",
