...
export const zhCN: Translations = {
  ...
  capabilities: {
    ...
    sharedSkills: "共享技能",
    title: "能力中心",
    description: "为你的工作添加工具与技能，让 DeepHourAI 更懂你的工作方式。",
    plugins: "插件",
    skills: "技能",
  ...
  welcome: {
    greeting: "你好，欢迎回来！",
    description:
      "欢迎使用 DeepHourAI 智能体平台。通过内置和自定义的 Skills，\nDeepHourAI 可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n图片、视频、播客及网页等，几乎可以做任何事情。",

    createYourOwnSkill: "创建你自己的 Agent SKill",
    createYourOwnSkillDescription:
      "创建你的 Agent Skill 来释放 DeepHourAI 的潜力。通过自定义技能，DeepHourAI\n可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n网页等作品，几乎可以做任何事情。",
  },
  ...
  inputBox: {
    ...
    voiceInputStart:
      "语音输入。DeepHourAI 只接收转写文本，音频由浏览器或系统语音服务处理。",
  ...
  backgroundTasks: {
    ...
    cancellationRetrying: (attempt) =>
      `第 ${attempt} 次取消失败；DeepHourAI 将继续重试。`,
    notificationRetrying: (attempt) =>
      `第 ${attempt} 次聊天通知失败；DeepHourAI 将退避后重试。`,
    notificationStopped: "聊天通知因反复失败或永久拒绝，已停止重试。",
    trackingDegraded: "状态检查有所延迟，DeepHourAI 仍在重试。",
    viewDetails: "查看详情",
    hideDetails: "收起详情",
  ...
  scheduledTasks: {
    ...
    context: {
      ...
      reuseNoticeDescription:
        "如果触发时该线程正在运行，DeepHourAI 会将本次执行排队，并在线程空闲后启动；超过配置的最长等待时间后会标记为失败。",
    },
    search: {
  ...
  agents: {
    ...
    saving: "正在保存智能体...",
    saveRequested:
      "已提交保存请求，DeepHourAI 正在根据当前对话生成并保存初版智能体。",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "智能体已创建，但 DeepHourAI 暂时还无法读取到它。请稍后刷新当前页面。",
    more: "更多操作",
    agentCreated: "智能体已创建！",
    startChatting: "开始对话",
  ...
  // Workspace
  workspace: {
    officialWebsite: "访问 DeepHourAI 官方网站",
    githubTooltip: "访问 DeepHourAI 的 GitHub 仓库",
    settingsAndMore: "设置和更多",
    visitGithub: "在 GitHub 上查看 DeepHourAI",
    reportIssue: "报告问题",
    contactUs: "联系我们",
    about: "关于 DeepHourAI",
    logout: "退出登录",
  ...
  channels: {
    ...
    saveChanges: "保存修改",
    descriptions: {
      buzz: "通过 DeepHourAI 智能体接收 Buzz 频道消息和私聊。",
      telegram: "通过 DeepHourAI Bot 接收 Telegram 私聊消息。",
      slack: "接收 Slack 工作区消息和提及。",
      discord: "通过 DeepHourAI Bot 接收 Discord 服务器消息。",
      feishu: "通过 DeepHourAI 应用接收飞书和 Lark 消息。",
      dingtalk: "通过 DeepHourAI Bot 接收钉钉 Stream Push 消息。",
      wechat: "通过 DeepHourAI Bot 接收微信 iLink 消息。",
      wecom: "通过 DeepHourAI AI Bot 接收企业微信消息。",
    },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "安装技能并使其可在 DeepHourAI 中使用",
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription: "使用键盘快捷键更快地操作 DeepHourAI。",
  ...
  settings: {
    title: "设置",
    description: "根据你的偏好调整 DeepHourAI 的界面和行为。",
    sections: {
      account: "账号",
      appearance: "外观",
      channels: "渠道",
    ...
    memory: {
      title: "记忆",
      description:
        "DeepHourAI 会在后台不断从你的对话中自动学习。这些记忆能帮助 DeepHourAI 更好地理解你，并提供更个性化的体验。",
      empty: "暂无可展示的记忆数据。",
      rawJson: "原始 JSON",
      exportButton: "导出记忆",
      exportSuccess: "记忆已导出",
  ...
  "mcpServers": {
    ...
    channels: {
      title: "渠道",
      description: "连接可在浏览器外向 DeepHourAI 发送消息的即时通讯账号。",
      disabled:
    ...
    integrations: {
      ...
      lark: {
        ...
        changeAppDescription:
          "把你的 DeepHourAI 账号指向另一个 Lark/飞书 App。只影响你自己的账号，不影响其他用户。",
        ...
        authStarted: "授权页已打开，DeepHourAI 会自动检测授权结果。",
        authorizationStillPending:
          "还没有检测到授权完成。请在浏览器完成授权；DeepHourAI 会继续自动检测。如果页面没有更新，可点击“我已完成授权”。",
        ...
        openAuthLinkDescription:
          "打开下面的链接完成授权。DeepHourAI 会持续自动检测，并在授权通过后保存连接状态。",
        waitingAuthTitle: "等待飞书授权完成",
        waitingAuthDescription:
          "请在刚打开的浏览器页面完成授权。DeepHourAI 会自动更新这里的状态；下方按钮只是兜底操作。",
        openAuthLink: "打开链接",
        copyAuthLink: "复制链接",
        completeAuth: "我已完成授权",
        ...
        authNextDescription:
          "点击“连接飞书”后，DeepHourAI 会先检查当前状态；未连接或授权过期时会拉起浏览器授权。",
      },
    },
    skills: {
      ...
      emptyTitle: "还没有技能",
      emptyDescription:
        "将你的 Agent Skill 文件夹放在 DeepHourAI 根目录下的 `/skills/custom` 文件夹中。",
    ...
    notification: {
      title: "通知",
      description:
        "DeepHourAI 只会在窗口不活跃时发送完成通知，特别适合长时间任务：你可以先去做别的事，完成后会收到提醒。",
    ...
    account: {
      ...
      ssoPasswordMessage:
        "此账号通过 {provider} 登录，DeepHourAI 无法在此管理或修改密码。请前往你的 SSO 提供商账号设置中进行操作。",
  ...
  login: {
    ...
    adminSetupRequiredDescription:
      "DeepHourAI 需要先创建管理员账号，然后才能创建新的普通账号。",
