...
description: This tutorial shows you how to configure and use tools and skills in DeepHourAI to give the agent access to web search, file operations, and domain-specific capabilities.
---
...
This tutorial shows you how to configure and use tools and skills in DeepHourAI to give the agent access to web search, file operations, and domain-specific capabilities.
...
Enable skills through Capability Center → Skills, or edit `extensions_config.json` directly.

**Via the app UI:**

1. Open the DeepHourAI app
2. Open Capability Center in the sidebar, then select Skills
