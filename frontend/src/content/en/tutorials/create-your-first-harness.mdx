...
description: This tutorial shows you how to use the DeepHourAI Harness programmatically — importing and using DeepHourAI directly in your Python code rather than through the web interface.
---
...
This tutorial shows you how to use the DeepHourAI Harness programmatically — importing and using DeepHourAI directly in your Python code rather than through the web interface.

## Prerequisites

- Python 3.12+
- `uv` installed
- DeepHourAI repository cloned
