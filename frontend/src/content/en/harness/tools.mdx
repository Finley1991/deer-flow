...
<Callout type="info" emoji="🔧">
  Tools are the actions the Lead Agent can take. DeepHourAI provides built-in
...
DeepHourAI organizes tools into four categories:
...
through DeepHourAI's artifact system. This is useful for visual evidence, UI checks,
