...
description: DeepHourAI App is the reference implementation of what a production DeepHourAI experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
---
...
<Callout type="info" emoji="🚀">
  DeepHourAI App is a complete Super Agent application built on top of DeepHourAI
...
DeepHourAI App is the reference implementation of what a production DeepHourAI experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
...
The DeepHourAI App runs behind a single nginx reverse proxy:
...
| Agent runtime     | LangGraph, LangChain, DeepHourAI Harness                               |
| Reverse proxy     | nginx                                                                |
