"""Fixtures for the DeepHourAI Monocle behavioural tests.
...
def run_agent() -> Callable[[str], str]:
    ...
    Skips unless ``MONOCLE_LIVE_TESTS=1`` is set, when the DeepHourAI app is not
    ...
    pytest.importorskip("deerflow", reason="DeepHourAI app not importable in this venv")
