...
into the image. The runtime directories are written by a *running* DeepHourAI, not by
...
host that has run DeepHourAI bakes that state — including the JWT secret and the user
