...
This document describes how to use and maintain DeepHourAI backend blocking-IO
...
Keeping rules centralized makes it clear which extra primitives DeepHourAI
