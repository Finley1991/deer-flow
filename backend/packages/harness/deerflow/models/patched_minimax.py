...
``langchain_openai.ChatOpenAI`` currently ignores that field, so DeepHourAI's
...
which DeepHourAI already understands.
"""
...
class PatchedChatMiniMax(ChatOpenAI):
    ...
    def _strip_user_message_names(payload: dict) -> None:
        ...
        DeepHourAI middlewares tag user messages with internal provenance names
