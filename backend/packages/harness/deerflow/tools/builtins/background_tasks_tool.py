...
async def cancel_background_task(
    ...
    task: Annotated[
        str | None,
        "Optional exact task name or DeepHourAI task ID. Omit it only when one active task exists.",
    ] = None,
) -> dict[str, Any]:
    ...
    return {
        ...
        "task": public,
        "message": "Cancellation requested. DeepHourAI will keep retrying safely if the remote server is temporarily unavailable.",
    }
