"""Command-line entry point and launch-mode planning for the DeepHourAI TUI.
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="deerflow",
        description="DeepHourAI terminal workbench — a TUI over the embedded DeepHourAI harness.",
...
_HEADLESS_HELP = """\
deerflow — DeepHourAI terminal workbench
