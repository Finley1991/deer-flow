"""Minimal asynchronous client for the LightRAG APIs DeepHourAI consumes."""
...
class LightRAGClient:
    """Direct HTTP client for DeepHourAI's read-only retrieval tools.
    ...
    async def query_data(
        ...
        *,
        ...
        read-only shape DeepHourAI's knowledge tool consumes.
        """
