...
System-model-call observers cover DeepHourAI-owned model invocations that do not pass
...
host hook, which the DeepHourAI-side callbacks translate into an observation and submit
