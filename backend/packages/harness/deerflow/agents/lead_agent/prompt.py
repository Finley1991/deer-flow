...
user-managed data (visible and editable via the DeepHourAI UI) — you may
...
DeepHourAI is an open-source AI agent framework that gained significant traction in early 2026
[citation:GitHub Repository](https://github.com/Finley1991/deer-flow). The project focuses on
providing a production-ready agent system with sandbox execution and memory management
[citation:DeepHourAI Documentation](https://deer-flow.dev/docs).
...
### Primary Sources
- [GitHub Repository](https://github.com/Finley1991/deer-flow) - Official source code and documentation
- [DeepHourAI Documentation](https://deer-flow.dev/docs) - Technical specifications
...
- ✅ RIGHT in Sources: `[GitHub Repository](https://github.com/Finley1991/deer-flow) - 官方源代码和文档`
...
def apply_prompt_template(
    ...
    *,
    ...
    return SYSTEM_PROMPT_TEMPLATE.format(
        agent_name=agent_name or "DeepHourAI 2.0",
