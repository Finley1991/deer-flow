...
def _canonical_peer_id(
    ...
    """Map DeepHourAI's case-insensitive agent names to disjoint peer IDs."""
...
def _session_id(
    ...
    """Derive one stable OpenViking session for one DeepHourAI thread."""
...
def _captureable_messages(
    ...
    """Drop DeepHourAI-only injected context before handing messages to OpenViking."""
