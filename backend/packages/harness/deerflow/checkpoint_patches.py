...
that builds a DeepHourAI graph (gateway, workers, in-process LangGraph
...
def _as_overwrite(value: Any) -> tuple[bool, Any]:
    ...
    DeepHourAI's write paths produce for these Union channels (the branch and
    ...
    an internal serialization detail DeepHourAI never emits into these channels.
    """
