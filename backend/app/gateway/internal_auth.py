...
INTERNAL_AUTH_HEADER_NAME = "X-DeepHourAI-Internal-Token"
INTERNAL_OWNER_USER_ID_HEADER_NAME = "X-DeepHourAI-Owner-User-Id"
...
def get_internal_user(owner_user_id: str | None = None):
    ...
    ``X-DeepHourAI-Owner-User-Id`` header), the synthetic user's ``.id``
