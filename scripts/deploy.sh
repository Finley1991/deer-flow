#!/usr/bin/env bash
#
# deploy.sh - Build, start, or stop DeepHourAI production services
#
# Commands:
...
if [ "$CMD" = "build" ]; then
    echo "=========================================="
    echo "  DeepHourAI — Building Images"
    echo "=========================================="
    echo ""
...
echo "=========================================="
echo "  DeepHourAI Production Deployment"
echo "=========================================="
echo ""
...
report_startup_failure() {
    echo -e "${RED}✗ DeepHourAI services failed to become ready.${NC}" >&2
