#!/usr/bin/env python3
"""Create a redacted DeepHourAI support bundle for community troubleshooting."""
...
def render_issue_summary(triage: dict[str, Any]) -> str:
    ...
    lines = [
        "## DeepHourAI support bundle summary",
        "",
...
def render_ai_issue_draft(triage: dict[str, Any], issue_summary: str, doctor: dict[str, Any] | None) -> str:
    ...
    lines = [
        "# AI issue draft",
        "",
        "Use this when a coding agent or AI assistant files a DeepHourAI bug report.",
        ...
        "### Before you start",
        "",
        "- [ ] I searched [existing issues](https://github.com/Finley1991/deer-flow/issues?q=is%3Aissue) and this is not a duplicate.",
        ...
        "```",
        "",
        "### How are you running DeepHourAI?",
        "",
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--project-root", type=Path, default=repo_root, help="DeepHourAI project root")
